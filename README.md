...
### [SyncBlock-AutoCAD](https://github.com/beastt1992/SyncBlock-AutoCAD)
**Synchronize block definitions across drawings.**  
Update blocks in multiple DWGs at once, with color inheritance support.

---

### [autocad-batch-plot](https://github.com/beastt1992/autocad-batch-plot)
**Batch export title block frames to individual PDFs.**  
Select all your sheets, export each one automatically — no manual plotting.
...
*Built with AutoLISP · MIT License · Compatible with AutoCAD 2014+, BricsCAD, GstarCAD*
